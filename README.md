# Template for writing a PhD thesis in Markdown [![Build Status](https://travis-ci.org/grmpfhmbl/phd_thesis_markdown.svg?branch=master)](https://travis-ci.org/grmpfhmbl/phd_thesis_markdown)
